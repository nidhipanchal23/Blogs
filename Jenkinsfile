    ...
    stages {
        ...
        stage('run') {
            steps {
                ...
                sh '. venv/bin/activate && python3 manage.py makemigrations && python3 manage.py migrate'
                sh '/var/lib/jenkins/workspace/hubstaff4/gunicorn blog.wsgi:application --bind 0.0.0.0:8000'
                }
         }
